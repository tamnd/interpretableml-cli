...
Most of these come down to network reality or how interpretableml serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

interpretableml rate-limits like any public site. iml already paces
...
Where a surface is gated, iml reads a cookie or token you supply
...
`iml`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what iml actually did
